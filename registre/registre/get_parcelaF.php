...
$sql = "SELECT m.numar, m.suprafata, d.nume, d.prenume from mormant m, decedat d where m.id_mormant=d.id_mormant and m.monument LIKE '%DA%' 
and m.id_cimitir in (select c.id_cimitir from cimitir c where c.parcela LIKE '%F%') ";
