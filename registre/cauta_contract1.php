...
$cauta ="SELECT distinct concesionar.id_concesionar,nume,prenume,adresa,contract.data_semnare, concesionar.CNP FROM concesionar, contract WHERE concesionar.id_concesionar=contract.id_concesionar and contract.data_semnare LIKE '%2015%' AND nume LIKE  '$search' OR prenume LIKE  '$search'";
$myData = mysqli_query($con, $cauta);
echo '<h4>Tabelul dupa nume</h4>' ;
echo "<table border=3>
<tr>
<th>Id</th>
<th>Nume</th>
