...
function hideit() {              
 document.getElementById("headerul").style.display = 'none';
}
</script>
</head>
<body>
<div class="header" id="headerul">
<h2>CONTRACT DE CONCESIUNE</h2>
	<li><a href="adauga_contract.html" id="headerul">Inapoi</a></li>
<A HREF="javascript:window.print()" onclick="hideit()" id="headerul">Click to Print This Page</A>
</div>
<?php if(isset($_POST['cnp1'])){ echo '
<h3>NR '.$nr_contract."/".$data.'</h3>';} ?>
...
<?php if(isset($_POST['cnp1'])){ echo '
    ...
    D-nul/D-na ' . $nume1 . ' ' . $prenume1 . ' , CNP ' . $cnp1 . ', cu domiciliul in ' . $adr1 .' si 
	D-nul/D-na ' . $nume2 . ' ' . $prenume2.' , CNP ' . $cnp2 . ', cu domiciliul in '. $adr2 .' , in calitate 
	...
	Art. 2. Obiectul contractului este concesionarea locului de inhumare situat in cimitirul '.$cimitir.',
	parcela '.$parcela .', nr. '. $nr_mormant.'.<br></br>
	...
	'. $data1.' a anului urmator anului in care expira durata contractului.<br></br>
	IV. Redeventa
	...
	cu chitanta nr. '.$nr_chitanta.' in baza:<br></br>
	&#149	cererii nr.'. $cerere.'/'.$data_cerere.'  inregistrata la registratura Primariei Cluj-Napoca.<br></br>
	&#149	adeverintei de inhumare  nr______  emisa de Primaria Cluj-Napoca.<br></br>
	&#149	reconcesionarii cu prezentarea fotografiei locului de inhumare.<br></br>
