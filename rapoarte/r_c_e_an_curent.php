...
$sql = "select distinct concesionar.nume, prenume, cnp, mormant.numar,suprafata,cimitir.nume_cimitir, parcela from concesionar, mormant, cimitir, contract where concesionar.id_concesionar=contract.id_concesionar and contract.id_mormant=mormant.id_mormant and mormant.id_cimitir=cimitir.id_cimitir and contract.data_semnare LIKE '%1995%'";
$myData = mysqli_query($con,$sql);
// create the table
echo '<h4>Rapoarte despre toate contractelor de concesiune care expira in anul curent</h4>' ;
